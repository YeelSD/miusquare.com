...
<head>
    ...
    <meta name="description" content="Proporcionando servicios de alta calidad respaldados por experiencia y conocimientos especializados.">
...
<body>
                    ...
                    <div class="col-xl-8 col-lg-9">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="nav-content">   
                            <ul class="navbar-nav text-center mt-lg-0 mt-5">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link js-scroll-trigger" href="#ourThoughtsWrapper">NOSOTROS</a>
                                </li>
                                <li class="nav-item">
        ...
        <div id="whyusWrapper" class="row">
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills mb-5 justify-content-between" id="pills-tab" role="tablist">
                    <li class="col-xl-3 col-lg-3 col-md-6 col-12 nav-item mb-4 text-center">
                        <a class="nav-link <?php if($tab == '1') { echo 'active'; }; ?>" id="pills-sketch-tab" data-toggle="pill" href="#pills-sketch" role="tab" aria-controls="pills-sketch" aria-selected="<?php if($tab == '1') { echo 'true'; } else { echo 'false'; }; ?>">
                    ...
                    <li class="col-xl-3 col-lg-3 col-md-6 col-12 nav-item mb-4 text-center">
                        <a class="nav-link <?php if($tab == '2') { echo 'active'; }; ?>" id="pills-design-tab" data-toggle="pill" href="#pills-design" role="tab" aria-controls="pills-design" aria-selected="<?php if($tab == '2') { echo 'true'; } else { echo 'false'; }; ?>">
                    ...
                    <li class="col-xl-3 col-lg-3 col-md-6 col-12 nav-item mb-4 text-center">
                        <a class="nav-link <?php if($tab == '3') { echo 'active'; }; ?>" id="pills-development-tab-2" data-toggle="pill" href="#pills-development-2" role="tab" aria-controls="pills-development-2" aria-selected="<?php if($tab == '3') { echo 'true'; } else { echo 'false'; }; ?>">
                    ...
                    <li class="col-xl-3 col-lg-3 col-md-6 col-12 nav-item mb-4 text-center">
                        <a class="nav-link <?php if($tab == '4') { echo 'active'; }; ?>" id="pills-development-tab" data-toggle="pill" href="#pills-development" role="tab" aria-controls="pills-development" aria-selected="<?php if($tab == '4') { echo 'true'; } else { echo 'false'; }; ?>">
            ...
            <div class="col-md-12">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade <?php if($tab == '1') { echo 'show active'; }; ?>" id="pills-sketch" role="tabpanel" aria-labelledby="pills-sketch-tab">
                        <div class="row">
                    ...
                    <div class="tab-pane fade <?php if($tab == '2') { echo 'show active'; }; ?>" id="pills-design" role="tabpanel" aria-labelledby="pills-design-tab">
                        <div class="row">
                            <div class="col-md-6 text-center">
                    ...
                    <div class="tab-pane fade <?php if($tab == '3') { echo 'show active'; }; ?>" id="pills-development-2" role="tabpanel" aria-labelledby="pills-development-tab-2">
                        <div class="row">
                            <div class="col-md-6 text-center">
                    ...
                    <div class="tab-pane fade <?php if($tab == '4') { echo 'show active'; }; ?>" id="pills-development" role="tabpanel" aria-labelledby="pills-development-tab">
                        <div class="row">
                            <div class="col-md-6 text-center">
    ...
    <div class="container">
        <div id="ourThoughtsWrapper" class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 site-content-inner align-self-center order-2  mb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 site-content-inner text-md-center text-center copyright">
                            ...
                            <p><i class="flaticon-telephone"></i> <a href="tel:523338013080" class="phone-footer"> +52 33 3801-3080</a> <br>
                                <i class="flaticon-telephone"></i><a href="tel:523338013080" class="phone-footer"> +52 33 3160-3681</a></p>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mx-auto col-lg-6 col-md-6 site-content-inner text-md-left text-center copyright align-self-center">
                            <p class="mt-md-0 mt-4 mb-0">© 2024 <a href="https://yeel.com.mx/" target="_blank">Derechos Reservados</a>.</p>
                        </div>
                    </div>
                </div>        
            </div>
